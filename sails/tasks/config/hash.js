  ...
  grunt.config.set('hash', {
    options: {
      ...
      hashFunction: function(source, encoding) {
        if(!source || !encoding) {
          throw new Error('Consistency violation: Cannot compute unique hash for '
            + 'production .css/.js cache-busting suffix,because `source` and/or `encoding` are falsey-- '
            + 'but they should be truthy strings! Here they are, respectively:\nsource: '
